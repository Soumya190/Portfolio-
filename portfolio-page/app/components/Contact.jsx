...
const Contact = () => {
  const [icons, setIcons] = useState([
    {
      url: "https://www.linkedin.com/in/soumya-tiwari-a33160269/",
      svg: (
    ...
    {
      url: "soumyatiwari7866@gmail.com",
      svg: (
    ...
    {
      url: "https://github.com/Soumya190",
      svg: (
  ...
  return (
    <div className="h-screen grid gap-5 place-content-center items-center">
