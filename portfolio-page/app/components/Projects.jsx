  ...
  const projects=[
    {
      ...
      description:"Developed a news portal website using React that allows users to get news based on selected categories and keyword search. Implemented pagination using Vite for smooth navigation from one page to another, Improved site efficiency by 30%",
      url:"",
    ...
    },
    {
      ...
      description:"Crafted a responsive multi-step form application using React. Worked on form validation and error handling to ensure data integrity and user experience, enhanced website speed by 20%",
    ...
    },
    {
      ...
      description:"Designed and developed a responsive restaurant website showcasing Indian and Chinese cuisine menus, enhancing user experience with intuitive navigation and visually appealing design. Achieved a 30% increase in website performance, improving website performance by 40%",
            ...
            {projects.map((elem, index) => {
              return (
                <>
                 ...
                 <div className="grid gap-3  px-5 py-5  border-gradient-to-r shadow-2xl rounded-2xl from-[#78847C] to-[#B3BFB8] border-2">
                    <Image
                      src={elem.image}
                      alt="News Website"
                      width={340}
                    ...
                    />
                    <p className="text-2xl font-semibold mb-2">{elem.text}</p>
                    <p className="text-base text-white">{elem.description}</p>
