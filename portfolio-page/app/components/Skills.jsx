...
const Skills = () => {
  const skills = [
    {
      logo: (
        <svg
          ...
          viewBox="0 0 384 512"
          className="w-13 items-center h-13 lg:w-20 lg:h-20"
        >
          <path
            fill="#ff8040"
  ...
  return (
    <>
      <div
        id="skills"
        className="min-h-screen flex flex-col justify-center items-center px-4 py-8 md:gap-10 md:py-14 lg:grid lg:p-30"
      >
        <p className="text-2xl md:text-4xl lg:text-5xl font-semibold p-5">
          Skills & Tools
        </p>

        {showSkills ? (
          <>
            <div className="grid gap-8 md:grid-cols-2 md:gap-10 lg:flex lg:justify-around lg:items-center">
              <div className="w-[20rem] h-[27rem] md:w-[22rem] md:h-[22rem] lg:w-[30rem] lg:h-[20rem] sm:p-2 lg:px-10 border-gradient-to-r grid border-gradient-to-r rounded-2xl from-[#78847C] to-[#B3BFB8] shadow-2xl border-2">
                ...
                <div className="grid h-[10rem] place-content-center items-center">
                  <div className="grid gap-3 md:grid-cols-2 md:gap-4 lg:flex lg:gap-6">
                    {skills.map((elem, index) => (
                      <React.Fragment key={index}>
                        <div className="grid place-content-center gap-2 items-center lg:gap-4">
                          <p className="items-center pr-0">{elem.logo}</p>
                          <div className="text-sm md:text-base lg:text-md grid place-content-center items-center">
                            <p>{elem.language}</p>
                          </div>
                        </div>
                      </React.Fragment>
              ...
              <div className="w-[20rem] h-[25rem] md:w-[22rem] md:h-[22rem] lg:w-[30rem] lg:h-[20rem] sm:p-2 lg:px-10 border-gradient-to-r grid border-gradient-to-r rounded-2xl from-[#78847C] to-[#B3BFB8] shadow-2xl border-2">
                <div className="h-5">
                  <p className="text-md md:text-lg lg:text-xl text-center py-4 font-semibold">
                ...
                <div className="grid h-[10rem] place-content-center items-center">
                  <div className="grid gap-2 md:grid-cols-2 md:gap-4 lg:flex lg:gap-11">
                    {tools.map((elem, index) => (
                      <React.Fragment key={index}>
                        <div className="grid place-content-center items-center gap-4">
                          <p>{elem.logo}</p>
