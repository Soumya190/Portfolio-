...
const Skills = () => {
  ...
  const tools=[
    {
      logo:<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="w-20 h-20">
      <path
        fill="#c0c0c0"
    ...
    {
      logo:<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className="w-20 h-20">
        ...
        {showSkills ? (
          <>
            <div className="flex justify-around">
              <div className="h-[20rem] grid w-[30rem] px-10 border-gradient-to-r rounded-2xl from-[#78847C] to-[#B3BFB8] border-2 ">
                <div className="h-5">
                <p className="text-center text-xl py-4 font-semibold">
                ...
                <div className="grid h-[10rem] place-content-center items-center">
                  <div className="flex gap-5">
                    {skills.map((elem, index) => {
                      return (
                        <>
                          <div index={index} className="grid place-content-center items-center gap-4">
                            <p >{elem.logo}</p>
